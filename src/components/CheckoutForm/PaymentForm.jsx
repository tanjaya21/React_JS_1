...
const PaymentForm = ({ checkoutToken, backStep, shippingData, onCaptureCheckout, nextStep, timeout }) => {
    ...
    const handleSubmit = async (event, elements, stripe) =>{ 
        ...
        if (error){
            ...
            // it will be containing all the data from the user and the data will be stored in the orderData
            const orderData = {
    ...
    return (
        <>
            ...
            <Elements stripe={ stripePromise }>
                {/* accepting something from stripe and going to destructure that */}
                <ElementsConsumer>
                    {({ elements, stripe })=>(
